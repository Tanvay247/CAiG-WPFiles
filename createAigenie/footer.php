      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
          <div class="w-full mb-10">
            <a href="javascript:void(0)" class="inline-block max-w-[160px] mb-6 text-2xl text-white font-bold">
              CreatAIGenie
</a>
          ...
          <div class="w-full md:w-1/3 lg:w-1/2 px-4">
            <div class="flex justify-center md:justify-end my-1">
              <p class="text-base text-[#f3f4fe]">
                ...
                <a href="https://digitalherculesinnovations.com/" rel="nofollow noopner" target="_blank"
