...
<div id="home" class="relative pt-[120px] md:pt-[130px] lg:pt-[160px]"
  style="background-image: url('<?php bloginfo('template_directory') ?>/assets/images/hero/background.jpg'); background-repeat: no-repeat; background-size: cover;">
  <div class="container">
      ...
      <div class="w-full px-4">
        <div class="
          ...
          <h1 class="
                  ...
                  mb-8
                ">
            Let AI boost your Art,Essay,Blog
          </h1>
          <p class="
                  text-base
            ...
            Trusted by 500 000+ business and writers.
          ...
          <div class="
            ...
            <div class="
              ...
              <p class="text-base text-body-color mb-9 leading-relaxed">
                Digital Hercules Innovations introduces CreatAiGenie, an AI-powered content generation app designed to
                enhance productivity for professionals, creators, and students. From managing time to generating
                ideas, translating languages, aiding writing tasks, and more, CreatAiGenie simplifies various tasks.
                It creates images, videos, voiceovers, music, and ChatGPT-like text from minimal input. With
                ready-made chatbot templates, users effortlessly craft custom solutions for writing, academic queries,
                and more. Enjoy real-time updates, seamless web integration, and three account types: general user,
                creator, and enterprise.
              </p>
              <p class="text-base text-body-color mb-9 leading-relaxed">
                You are a Home décor business owner at Amazon and want to promote your brand on social media:
                Our app will import data of your Amazon account
                You can just search your product on our app and the results will be extracted.
                After the extraction our app will go through the Brand Voice (a feature which stores the brand story)
                and in accordance to it write content for the social media post while promoting your product and it’s
                URL.
                After doing so our app will ask you to set a preferred time for post schedule and post such content for
                you on automation to any groups you are a member of. 
                Our app will also offer Ai-based Recommendations of how to improve the engagement of viewers after going
                through analytics
              </p>
            ...
            <div class="text-center">
              <div class="relative inline-block z-10">
                <img src="<?php bloginfo('template_directory') ?>/assets/images/about/aboutfinal.jpg" alt="image"
...
<!-- ====== Video Section End -->
<section id="waitlist" class="bg-[#f3f4fe] w-[100%]">
    ...
    <div class="flex flex-wrap">
        ...
        <div class="
          ...
          <div class="ud-testimonial-content mb-6">
            <p class="text-base tracking-wide text-body-color">
              “CreatAiGenie has been a game-changer for me. As a freelance writer, time is money, and this app saves
              me hours of brainstorming and drafting. Plus, the quality of content it generates is impressive. Highly
              recommended.
            </p>
          </div>
          <div class="ud-testimonial-info flex items-center">
            <div class="
                    ...
                    mr-5
                  ">
              <img src="<?php bloginfo('template_directory') ?>/assets/images/testimonials/author-01.png"
                alt="author" />
            </div>
      ...
      <div class="w-full md:w-1/2 lg:w-1/3 px-4">
        <div class="
          ...
          <div class="ud-testimonial-content mb-6">
            <p class="text-base tracking-wide text-body-color">
              “I stumbled upon CreatAiGenie while searching for content creation tools, and I'm so glad I did. It's
              incredibly intuitive to use, and I love how it seamlessly generates text, images, and even videos. It's
              like having a creative assistant at your fingertips
            </p>
          </div>
          <div class="ud-testimonial-info flex items-center">
            <div class="
                    ...
                    mr-5
                  ">
              <img src="<?php bloginfo('template_directory') ?>/assets/images/testimonials/author-02.png" alt="author" />
            </div>
            <div class="ud-testimonial-meta">
      ...
      <div class="w-full md:w-1/2 lg:w-1/3 px-4">
        <div class="
          ...
          <div class="ud-testimonial-content mb-6">
            <p class="text-base tracking-wide text-body-color">
              CreatAiGenie has become my go-to tool for content creation. Whether I need inspiration for blog posts or
              help with writing assignments, it never disappoints. The best part? It continuously evolves with new
              features and updates, keeping my creative juices flowing!
            </p>
          </div>
          <div class="ud-testimonial-info flex items-center">
            <div class="
                    ...
                    mr-5
                  ">
              <img src="<?php bloginfo('template_directory') ?>/assets/images/testimonials/author-03.png" alt="author" />
            </div>
            <div class="ud-testimonial-meta">
...
<section id="pricing" class="
  ...
  <div class="container">
      ...
      <div class="w-full px-4">
        <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[620px]">
          ...
          <p class="
                  ...
                  text-body-color
                ">
            Many companies have different approaches to pricing, but the majority tend to adjust their strategies over
            time.
          </p>
        </div>
      </div>
    ...
    <section class="dark:bg-gray-100 dark:text-[#b219f0]">
        ...
        <table class="w-full">
          ...
          <thead>
            <tr>
              <th></th>
              <th scope="col">
                <h2 class="px-2 text-2xl font-bold">CreatAIGenie</h2>

              </th>
              <th scope="col">
                <h2 class="px-2 text-2xl font-bold">Perplexity.ai</h2>

              </th>
              <th scope="col">
                <h2 class="px-2 text-2xl font-bold">Chatsmith</h2>

              </th>
              <th scope="col">
                <h2 class="px-2 text-2xl font-bold">You.com</h2>

              </th>
              <th scope="col">
                <h2 class="px-2 text-2xl font-bold">Sincode.ai</h2>

              </th>
              <th scope="col">
                <h2 class="px-2 text-2xl font-bold">Chatgpt</h2>
          ...
          <tbody class="space-y-6 text-center divide-y dark:divide-gray-300">
            <tr>
              <th scope="row" class="text-left">
                <h3 class="py-3">Human Like Content Generation</h3>
              </th>
              <td>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                  aria-label="Included in Free plan" class="w-5 h-5 mx-auto dark:text-violet-600">
              ...
              <td>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                  aria-label="Not included in Standard plan" class="w-5 h-5 mx-auto dark:text-gray-400">
            ...
            <tr>
              <th scope="row" class="text-left">
                <h3 class="py-3">Real Time Database</h3>
              </th>
              <td>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                  aria-label="Included in Free plan" class="w-5 h-5 mx-auto dark:text-violet-600">
            ...
            <tr>
              <th scope="row" class="text-left">
                <h3 class="py-3">Customize AI Bot</h3>
              </th>
              <td>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                  aria-label="Included in Free plan" class="w-5 h-5 mx-auto dark:text-violet-600">
            ...
            <tr>
              <th scope="row" class="text-left">
                <h3 class="py-3">Prebuilt Templates</h3>
              </th>
              <td>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                  aria-label="Included in Free plan" class="w-5 h-5 mx-auto dark:text-violet-600">
              ...
              <td>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                  aria-label="Included in Premium plan" class="w-5 h-5 mx-auto dark:text-violet-600">
                  <path fill-rule="evenodd"
                    d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
                    clip-rule="evenodd"></path>
                </svg>
